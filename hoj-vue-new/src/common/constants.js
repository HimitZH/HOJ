...
export const CONTEST_STATUS_REVERSE = {
  '-1': { name: 'Scheduled', color: '#f90' },
  '0': { name: 'Running', color: 'rgb(25, 190, 107)' }, // Updated color to match subtask
  '1': { name: 'Ended', color: '#ed4014' }
};
...
export const CONTEST_TYPE_REVERSE = {
  0: { name: 'Public', color: 'el-tag--success', tips: 'Public_Contest_Tips' },
  1: { name: 'Private', color: 'el-tag--danger', tips: 'Private_Contest_Tips' },
  2: { name: 'Protected', color: 'el-tag--warning', tips: 'Protected_Contest_Tips' }
};
