    ...
    <el-col :md="12" :sm="24">
      <el-card class="container">
        <div slot="header"><span class="panel-title home-title">Result Explanation</span></div>
          <ul class="result">
            <li>
              <span :class="getStatusColor(6)">Pending</span>&<span :class="getStatusColor(7)">Judging</span> :	您的解答将很快被测评，请等待结果。
            </li>
            <li>
              <span :class="getStatusColor(-2)">Compile Error</span> :	无法编译您的源代码，点击链接查看编译器的输出。

            </li>
             <li>
              <span :class="getStatusColor(-3)">Presentation Error</span> :	您提交的代码输出格式与评测输出不一致，请检查行末是否有多余空格。
            </li>
            <li>
            ...
            <li>
              <span :class="getStatusColor(4)">Runtime Error</span> : 您的程序异常终止，可能的原因是：段错误，被零除或用非0的代码退出程序。
              </li>
            <li>
            ...
            <li>
              <span :class="getStatusColor(5)">System Error</span> :	糟糕，判题机系统出了问题。请报告给管理员。
            </li>
          </ul>
      </el-card>
    </el-col>
