  ...
  <div>
    <el-card>
        ...
        <el-row :gutter="20">
          ...
          <el-col :md="8" :xs="24">
            <el-form-item label="Short Name" required>
              <el-input v-model="websiteConfig.shortName" placeholder="Website Name Shortcut"></el-input>
            </el-form-item>
          </el-col>

          <el-col :md="12" :xs="24">
            <el-form-item label="Record Name" required>
              <el-input v-model="websiteConfig.recordName" placeholder="Website Record Name"></el-input>
            </el-form-item>
          </el-col>
          <el-col :md="12" :xs="24">
            <el-form-item label="Record Url" required>
              <el-input v-model="websiteConfig.recordUrl" placeholder="Website Record Url"></el-input>
            </el-form-item>
          </el-col>
          <el-col :md="12" :xs="24">
            <el-form-item label="Project Name" required>
              <el-input v-model="websiteConfig.projectName" placeholder="Website Project Namet"></el-input>
            </el-form-item>
          </el-col>
          <el-col :md="12" :xs="24">
            <el-form-item label="Project Url" required>
              <el-input v-model="websiteConfig.projectUrl" placeholder="Website Project Url"></el-input>
            </el-form-item>
          </el-col>
          <el-col :md="24" :xs="24">
      ...
      <el-card style="margin-top:15px">
          ...
          <el-row :gutter="20">
            <el-col :md="24" :xs="24">
              <el-form-item label="Host" required label-width="80px">
                <el-input v-model="smtp.host" placeholder="SMTP Host Address"></el-input>
              </el-form-item>
            </el-col>
            <el-col :md="12" :xs="24">
              <el-form-item label="Username" required label-width="80px">
                <el-input v-model="smtp.username" placeholder="Account Username"></el-input>
              </el-form-item>
            </el-col>
            <el-col :md="12" :xs="24">
        ...
        <el-button type="primary" @click.native="saveSMTPConfig" size="small">Save</el-button>
        <el-button type="warning" @click.native="testSMTPConfig"
                  v-if="saved" :loading="loadingBtnTest" size="small">Send Test Email</el-button>
      </el-card>

    <el-card style="margin-top:15px">
        <div slot="header"><span class="panel-title home-title">DataBase Config</span></div>
        <el-form label-position="top" :model="databaseConfig">
          <el-row :gutter="20">
            <el-col :md="12" :xs="24">
              <el-form-item label="MySQL Host" required label-width="80px">
                <el-input v-model="databaseConfig.dbHost" placeholder="MySQL Host Address"></el-input>
              </el-form-item>
            </el-col>
            <el-col :md="12" :xs="24">
              <el-form-item label="MySQL Port" required label-width="80px">
                <el-input type="number" v-model="databaseConfig.dbPost" placeholder="MySQL Port"></el-input>
              </el-form-item>
            </el-col>
            <el-col :md="12" :xs="24">
              <el-form-item label="MySQL Username" required label-width="80px">
                <el-input v-model="databaseConfig.dbUsername" placeholder="Account username of MySQL"></el-input>
              </el-form-item>
            </el-col>
            <el-col :md="12" :xs="24">
              <el-form-item label="MySQL Password" label-width="80px" required>
                <el-input v-model="databaseConfig.dbPassword" type="password" placeholder="Account password of MySQL"></el-input>
              </el-form-item>
            </el-col>
            <el-col :md="12" :xs="24">
              <el-form-item label="Redis Host" label-width="80px" required>
                <el-input v-model="databaseConfig.redisHost" type="password" placeholder="Redis Host Address"></el-input>
              </el-form-item>
            </el-col>
            <el-col :md="12" :xs="24">
              <el-form-item label="Redis Port" label-width="80px" required>
                <el-input v-model="databaseConfig.redisPort" type="password" placeholder="Redis Port"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
        </el-form>
        <el-button type="primary" @click.native="saveDataBaseConfig" size="small">Save</el-button>
      </el-card>
  </div>
</template>
...
<script>
  ...
  export default {
    ...
    mounted () {
      ...
      api.admin_getWebsiteConfig().then(res => {
        this.websiteConfig = res.data.data
        }).catch(() => {
      }),
      api.admin_getDataBaseConfig().then(res => {
    ...
    methods: {
      saveSMTPConfig () {
          api.admin_editSMTPConfig(this.smtp).then((res) => {
      ...
      testSMTPConfig () {
        this.$prompt('Please input your email', '', {
          ...
          api.admin_testSMTPConfig(value).then((res) => {
            myMessage.success(res.data.msg)
      ...
      saveWebsiteConfig () {
        api.admin_editWebsiteConfig(this.websiteConfig).then((res) => {
          myMessage.success(res.data.msg)
          }).catch(() => {
        })
      },
      saveDataBaseConfig(){
        api.admin_editDataBaseConfig(this.databaseConfig).then((res) => {
          myMessage.success(res.data.msg)
          }).catch(() => {
        })
      }
