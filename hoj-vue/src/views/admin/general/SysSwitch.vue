        ...
        <el-col :xs="24" :md="8">
            <el-card>
                ...
                <el-form
                    ...
                    :model="switchConfig"
                >
                    <el-form-item :label="$t('m.Open_Public_Judge')" label-width="250px">
                        <el-switch
                    ...
                    <el-form-item :label="$t('m.Open_Group_Judge')" label-width="250px">
                        <el-switch
                    ...
                    <el-form-item :label="$t('m.Open_Contest_Judge')" label-width="250px">
                        <el-switch
                    ...
                    <el-form-item :label="$t('m.Non_Contest_Submission_Frequency')" label-width="250px">
                        <el-input-number
        ...
        <el-col :xs="24" :md="8">
            <el-card class="card-top">
                ...
                <el-form
                    ...
                    :model="switchConfig"
                >
                     <el-form-item :label="$t('m.Open_Public_Discussion')" label-width="250px">
                        <el-switch
                    ...
                    <el-form-item :label="$t('m.Open_Group_Discussion')" label-width="250px">
                        <el-switch
                    ...
                    <el-form-item :label="$t('m.Open_Contest_Comment')" label-width="250px">
                        <el-switch
                    ...
                    <el-form-item :label="$t('m.Number_of_AC_required_for_ordinary_users_to_post')" label-width="250px">
                        <el-input-number
                         v-model="switchConfig.defaultCreateDiscussionACInitValue" 
                         :min="0">
                         </el-input-number>
                    </el-form-item>
                    <el-form-item :label="$t('m.Number_of_posts_that_users_can_create_per_day')" label-width="250px">
                        <el-input-number
                         v-model="switchConfig.defaultCreateDiscussionDailyLimit" 
                         :min="0">
                         </el-input-number>
                    </el-form-item>
                    <el-form-item :label="$t('m.Number_of_AC_required_for_Comment_of_ordinary_users')" label-width="250px">
                        <el-input-number
        ...
        <el-col :xs="24" :md="8">
            <el-card class="card-top">
                ...
                <el-form
                    ...
                    :model="switchConfig"
                >
                    <el-form-item :label="$t('m.Number_of_Groups_that_users_can_create_per_day')" label-width="250px">
                        <el-input-number
                         v-model="switchConfig.defaultCreateGroupDailyLimit" 
                         :min="0">
                         </el-input-number>
                    </el-form-item>
                    <el-form-item :label="$t('m.Total_number_of_groups_that_ordinary_users_can_create')" label-width="250px">
                        <el-input-number
                         v-model="switchConfig.defaultCreateGroupLimit" 
                         :min="0">
                         </el-input-number>
                    </el-form-item>
                    <el-form-item :label="$t('m.Number_of_AC_required_for_ordinary_users_to_create_group')" label-width="250px">
                        <el-input-number
