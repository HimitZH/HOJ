...
public class RemoteJudgeResultSubscriberConfig {
    ...
    public RedisMessageListenerContainer getRedisMessageListenerContainer(RedisConnectionFactory redisConnectionFactory, MessageListenerAdapter messageListenerAdapter) {
        ...
        // 添加频道名字
        redisMessageListenerContainer.addMessageListener(messageListenerAdapter, new PatternTopic(Constants.RemoteJudge.STATUS_JUDGE_WAITING_RESULT.getName()));
