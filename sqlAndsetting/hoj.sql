...
INSERT INTO `language` VALUES (6, 'text/x-python', 'Python 3.7.5', 'Python3', '/usr/bin/python3 -m py_compile {src_path}', 'a, b = map(int, input().split())\r\nprint(a + b)', '//PREPEND BEGIN\r\n//PREPEND END\r\n\r\n//TEMPLATE BEGIN\r\ndef add(a, b):\r\n    return a + b\r\n//TEMPLATE END\r\n\r\n\r\nif __name__ == \'__main__\':  \r\n    //APPEND BEGIN\r\n    a, b = 1, 1\r\n    print(add(a, b))\r\n    //APPEND END', 0, 'ME', '2020-12-12 23:14:23', '2021-06-14 21:19:50');
...
INSERT INTO `language` VALUES (10, 'text/x-php', 'PHP 7.3.33', 'PHP', '/usr/bin/php {src_path}', '<?=array_sum(fscanf(STDIN, \"%d %d\"));', NULL, 0, 'ME', '2022-02-25 20:55:30', '2022-09-20 21:43:01');
INSERT INTO `language` VALUES (11, 'text/x-python', 'PyPy 2.7.18 (7.3.8)', 'PyPy2', '/usr/bin/pypy -m py_compile {src_path}', 'print sum(int(x) for x in raw_input().split(\' \'))', '//PREPEND BEGIN\n//PREPEND END\n\n//TEMPLATE BEGIN\ndef add(a, b):\n    return a + b\n//TEMPLATE END\n\n\nif __name__ == \'__main__\':  \n    //APPEND BEGIN\n    a, b = 1, 1\n    print add(a, b)\n    //APPEND END', 0, 'ME', '2022-02-25 20:55:30', '2022-09-20 21:43:03');
INSERT INTO `language` VALUES (12, 'text/x-python', 'PyPy 3.8.12 (7.3.8)', 'PyPy3', '/usr/bin/pypy3 -m py_compile {src_path}', 'print(sum(int(x) for x in input().split(\' \')))', '//PREPEND BEGIN\n//PREPEND END\n\n//TEMPLATE BEGIN\ndef add(a, b):\n    return a + b\n//TEMPLATE END\n\n\nif __name__ == \'__main__\':  \n    //APPEND BEGIN\n    a, b = 1, 1\n    print(add(a, b))\n    //APPEND END', 0, 'ME', '2022-02-25 20:55:30', '2022-09-20 21:43:06');
INSERT INTO `language` VALUES (13, 'text/javascript', 'Node.js 14.19.0', 'JavaScript Node', '/usr/bin/node {src_path}', 'var readline = require(\'readline\');\nconst rl = readline.createInterface({\n        input: process.stdin,\n        output: process.stdout\n});\nrl.on(\'line\', function(line){\n   var tokens = line.split(\' \');\n    console.log(parseInt(tokens[0]) + parseInt(tokens[1]));\n});', NULL, 0, 'ME', '2022-02-25 20:55:30', '2022-09-20 21:43:09');
INSERT INTO `language` VALUES (14, 'text/javascript', 'JavaScript V8 8.4.109', 'JavaScript V8', '/usr/bin/jsv8/d8 {src_path}', 'const [a, b] = readline().split(\' \').map(n => parseInt(n, 10));\nprint((a + b).toString());', NULL, 0, 'ME', '2022-02-25 20:55:30', '2022-09-20 21:43:14');
INSERT INTO `language` VALUES (15, 'text/x-csrc', 'GCC', 'GCC', NULL, NULL, NULL, 0, 'HDU', '2021-02-18 21:32:34', '2022-09-20 21:44:32');
INSERT INTO `language` VALUES (16, 'text/x-c++src', 'G++', 'G++', NULL, NULL, NULL, 0, 'HDU', '2021-02-18 21:32:58', '2022-09-20 21:44:34');
INSERT INTO `language` VALUES (17, 'text/x-c++src', 'C++', 'C++', NULL, NULL, NULL, 0, 'HDU', '2021-02-18 21:33:11', '2022-09-20 21:44:36');
INSERT INTO `language` VALUES (18, 'text/x-csrc', 'C', 'C', NULL, NULL, NULL, 0, 'HDU', '2021-02-18 21:33:41', '2022-09-20 21:44:38');
INSERT INTO `language` VALUES (19, 'text/x-pascal', 'Pascal', 'Pascal', NULL, NULL, NULL, 0, 'HDU', '2021-02-18 21:34:33', '2022-09-20 21:44:41');
INSERT INTO `language` VALUES (20, 'text/x-java', 'Java', 'Java', NULL, NULL, NULL, 0, 'HDU', '2022-09-20 21:25:00', '2022-09-20 21:44:46');
INSERT INTO `language` VALUES (21, 'text/x-csharp', 'C#', 'C#', NULL, NULL, NULL, 0, 'HDU', '2022-09-20 21:25:00', '2022-09-20 21:45:32');
INSERT INTO `language` VALUES (22, 'text/x-csrc', 'GNU GCC C11 5.1.0', 'GNU GCC C11 5.1.0', NULL, NULL, NULL, 0, 'CF', '2021-03-03 19:46:24', '2022-09-20 21:46:04');
INSERT INTO `language` VALUES (23, 'text/x-c++src', 'Clang++17 Diagnostics', 'Clang++17 Diagnostics', NULL, NULL, NULL, 0, 'CF', '2021-03-03 19:46:24', '2022-09-20 21:46:04');
INSERT INTO `language` VALUES (25, 'text/x-c++src', 'GNU G++14 6.4.0', 'GNU G++14 6.4.0', NULL, NULL, NULL, 0, 'CF', '2021-03-03 19:46:24', '2022-09-20 21:46:04');
INSERT INTO `language` VALUES (26, 'text/x-c++src', 'GNU G++17 7.3.0', 'GNU G++17 7.3.0', NULL, NULL, NULL, 0, 'CF', '2021-03-03 19:46:24', '2022-09-20 21:46:04');
INSERT INTO `language` VALUES (27, 'text/x-c++src', 'GNU G++20 11.2.0 (64 bit, winlibs)', 'GNU G++20 11.2.0 (64 bit, winlibs)', NULL, NULL, NULL, 0, 'CF', '2021-03-03 19:46:24', '2022-09-20 21:46:04');
INSERT INTO `language` VALUES (28, 'text/x-c++src', 'Microsoft Visual C++ 2017', 'Microsoft Visual C++ 2017', NULL, NULL, NULL, 0, 'CF', '2021-03-03 19:46:24', '2022-09-20 21:46:04');
INSERT INTO `language` VALUES (29, 'text/x-csharp', 'C# Mono 6.8', 'C# Mono 6.8', NULL, NULL, NULL, 0, 'CF', '2021-03-03 19:46:24', '2022-09-20 21:46:04');
INSERT INTO `language` VALUES (30, 'text/x-d', 'D DMD32 v2.091.0', 'D DMD32 v2.091.0', NULL, NULL, NULL, 0, 'CF', '2021-03-03 19:46:24', '2022-09-20 21:46:04');
INSERT INTO `language` VALUES (31, 'text/x-go', 'Go 1.15.6', 'Go 1.15.6', NULL, NULL, NULL, 0, 'CF', '2021-03-03 19:46:24', '2022-09-20 21:46:04');
INSERT INTO `language` VALUES (32, 'text/x-haskell', 'Haskell GHC 8.10.1', 'Haskell GHC 8.10.1', NULL, NULL, NULL, 0, 'CF', '2021-03-03 19:46:24', '2022-09-20 21:46:04');
INSERT INTO `language` VALUES (33, 'text/x-java', 'Java 1.8.0_241', 'Java 1.8.0_241', NULL, NULL, NULL, 0, 'CF', '2021-03-03 19:46:24', '2022-09-20 21:46:04');
INSERT INTO `language` VALUES (34, 'text/x-java', 'Kotlin 1.4.0', 'Kotlin 1.4.0', NULL, NULL, NULL, 0, 'CF', '2021-03-03 19:46:24', '2022-09-20 21:46:04');
INSERT INTO `language` VALUES (35, 'text/x-ocaml', 'OCaml 4.02.1', 'OCaml 4.02.1', NULL, NULL, NULL, 0, 'CF', '2021-03-03 19:46:24', '2022-09-20 21:46:04');
INSERT INTO `language` VALUES (36, 'text/x-pascal', 'Delphi 7', 'Delphi 7', NULL, NULL, NULL, 0, 'CF', '2021-03-03 19:46:24', '2022-09-20 21:46:04');
INSERT INTO `language` VALUES (37, 'text/x-pascal', 'Free Pascal 3.0.2', 'Free Pascal 3.0.2', NULL, NULL, NULL, 0, 'CF', '2021-03-03 19:46:24', '2022-09-20 21:46:04');
INSERT INTO `language` VALUES (38, 'text/x-pascal', 'PascalABC.NET 3.4.2', 'PascalABC.NET 3.4.2', NULL, NULL, NULL, 0, 'CF', '2021-03-03 19:46:24', '2022-09-20 21:46:04');
INSERT INTO `language` VALUES (39, 'text/x-perl', 'Perl 5.20.1', 'Perl 5.20.1', NULL, NULL, NULL, 0, 'CF', '2021-03-03 19:46:24', '2022-09-20 21:46:04');
INSERT INTO `language` VALUES (40, 'text/x-php', 'PHP 7.2.13', 'PHP 7.2.13', NULL, NULL, NULL, 0, 'CF', '2021-03-03 19:46:24', '2022-09-20 21:46:04');
INSERT INTO `language` VALUES (41, 'text/x-python', 'Python 2.7.18', 'Python 2.7.18', NULL, NULL, NULL, 0, 'CF', '2021-03-03 19:46:24', '2022-09-20 21:46:04');
INSERT INTO `language` VALUES (42, 'text/x-python', 'Python 3.9.1', 'Python 3.9.1', NULL, NULL, NULL, 0, 'CF', '2021-03-03 19:46:24', '2022-09-20 21:46:04');
INSERT INTO `language` VALUES (43, 'text/x-python', 'PyPy 2.7 (7.3.0)', 'PyPy 2.7 (7.3.0)', NULL, NULL, NULL, 0, 'CF', '2021-03-03 19:46:24', '2022-09-20 21:46:04');
INSERT INTO `language` VALUES (44, 'text/x-python', 'PyPy 3.7 (7.3.0)', 'PyPy 3.7 (7.3.0)', NULL, NULL, NULL, 0, 'CF', '2021-03-03 19:46:24', '2022-09-20 21:46:04');
INSERT INTO `language` VALUES (45, 'text/x-ruby', 'Ruby 3.0.0', 'Ruby 3.0.0', NULL, NULL, NULL, 0, 'CF', '2021-03-03 19:46:24', '2022-09-20 21:46:04');
INSERT INTO `language` VALUES (46, 'text/x-rustsrc', 'Rust 1.49.0', 'Rust 1.49.0', NULL, NULL, NULL, 0, 'CF', '2021-03-03 19:46:24', '2022-09-20 21:46:04');
INSERT INTO `language` VALUES (47, 'text/x-scala', 'Scala 2.12.8', 'Scala 2.12.8', NULL, NULL, NULL, 0, 'CF', '2021-03-03 19:46:24', '2022-09-20 21:46:04');
INSERT INTO `language` VALUES (48, 'text/javascript', 'JavaScript V8 4.8.0', 'JavaScript V8 4.8.0', NULL, NULL, NULL, 0, 'CF', '2021-03-03 19:46:24', '2022-09-20 21:46:04');
INSERT INTO `language` VALUES (49, 'text/javascript', 'Node.js 12.6.3', 'Node.js 12.6.3', NULL, NULL, NULL, 0, 'CF', '2021-03-03 19:46:24', '2022-09-20 21:46:04');
INSERT INTO `language` VALUES (50, 'text/x-csharp', 'C# 8, .NET Core 3.1', 'C# 8, .NET Core 3.1', NULL, NULL, NULL, 0, 'CF', '2021-03-25 21:17:39', '2022-09-20 21:46:04');
INSERT INTO `language` VALUES (51, 'text/x-java', 'Java 11.0.6', 'Java 11.0.6', NULL, NULL, NULL, 0, 'CF', '2021-03-25 21:20:03', '2022-09-20 21:46:04');
INSERT INTO `language` VALUES (52, 'text/x-c++src', 'G++', 'G++', NULL, NULL, NULL, 0, 'POJ', '2021-06-24 22:50:50', '2022-09-20 21:46:04');
INSERT INTO `language` VALUES (53, 'text/x-csrc', 'GCC', 'GCC', NULL, NULL, NULL, 0, 'POJ', '2021-06-24 22:51:04', '2022-09-20 21:46:04');
INSERT INTO `language` VALUES (54, 'text/x-java', 'Java', 'Java', NULL, NULL, NULL, 0, 'POJ', '2021-06-24 22:51:29', '2022-09-20 21:46:04');
INSERT INTO `language` VALUES (55, 'text/x-pascal', 'Pascal', 'Pascal', NULL, NULL, NULL, 0, 'POJ', '2021-06-24 22:51:50', '2022-09-20 21:46:04');
INSERT INTO `language` VALUES (56, 'text/x-c++src', 'C++', 'C++', NULL, NULL, NULL, 0, 'POJ', '2021-06-24 22:52:15', '2022-09-20 21:46:04');
INSERT INTO `language` VALUES (57, 'text/x-csrc', 'C', 'C', NULL, NULL, NULL, 0, 'POJ', '2021-06-24 22:52:38', '2022-09-20 21:46:04');
INSERT INTO `language` VALUES (58, 'text/x-fortran', 'Fortran', 'Fortran', NULL, NULL, NULL, 0, 'POJ', '2021-06-24 22:55:15', '2022-09-20 21:46:04');
